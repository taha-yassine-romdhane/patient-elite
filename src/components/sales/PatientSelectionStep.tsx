          ...
          <div className="bg-white rounded-xl border border-green-100 overflow-hidden shadow-sm">
            <div className="max-h-[60vh] overflow-y-auto">
              <table className="min-w-full">
                <thead className="sticky top-0 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-100">
                  <tr>
                    <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-green-800 uppercase tracking-wider">
                      Patient
                    </th>
                    <th scope="col" className="px-3 py-2 text-left text-xs font-semibold text-green-800 uppercase tracking-wider">
                      Contact
                    ...
                    <th scope="col" className="px-3 py-2 text-center text-xs font-semibold text-green-800 uppercase tracking-wider sticky right-0 bg-gradient-to-r from-green-50 to-emerald-50">
                      Action
                    </th>
                  </tr>
                </thead>
                <tbody className="bg-white">
                  {filteredPatients.map((patient, index) => (
                    <tr 
                      key={patient.id} 
                      className={`hover:bg-green-25 transition-colors duration-150 border-b border-green-50 ${index % 2 === 0 ? 'bg-white' : 'bg-green-25'}`}
                    >
                      ...
                      <td className="px-3 py-2.5 text-center sticky right-0 bg-white">
                        <button
                          ...
                          className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium text-sm rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-sm hover:shadow-md"
                        >
            ...
            {filteredPatients.length > 0 && (
              <div className="bg-green-25 px-4 py-2 border-t border-green-100">
