  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 py-6">
        <h2 className="text-2xl px-4 font-bold text-white mb-2">Sélectionner un patient</h2>
        <p className="text-purple-100 px-4">Choisissez le patient pour lequel vous souhaitez créer une location</p>
      </div>
